...
const Documentation: React.FC = () => {
  return (
    <div>
      ...
      <img src="/loginPage.jpg" alt="login page"></img>
      <p>
      ...
      <img src="/googleSignIn.jpg" alt="google auth login page"></img>
      <p>
      ...
      <img src="/loginProfile.jpg" alt="profile page"></img>
      <p>
      ...
      <img src="/profileEdit.jpg" alt="profile edit page"></img>
      <img src="/profileEditScroll.jpg" alt="profile edit page"></img>
      <p>
      ...
      <img src="/indexBoxed.jpg" alt="index tab boxed"></img>
      <p>
      ...
      <img src="/clickOnProfile.jpg" alt="click on a profile"></img>
      <p>
      ...
      <img src="/profileButton.jpg" alt="profile button boxed"></img>
      <p>To log out, simply click the logout tab.</p>
      <img src="/logoutButton.jpg" alt="logout button boxed"></img>
