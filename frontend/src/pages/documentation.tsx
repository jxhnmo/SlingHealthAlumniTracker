...
const Documentation: React.FC = () => {
    return (
        <div>
            ...
            <p>When a user comes to the app for the first time, they will be shown the login screen with a button they can click to log in.</p>
            <img src="public/loginPage.jpg" alt="login page"></img>
            <p>Once clicked, they will be prompted to sign in using a Google account for authentication. The chosen Google account will be bound to a unique profile and can be accessed in the future by simply logging in with that same Google account.</p>
            ...
            <img src="public/loginProfileEditBox.jpg" alt="profile page with edit button boxed"></img>
            ...
            <img src="public/profileEditSave.jpg" alt="profile edit page with save button boxed"></img>
            <p>To see the other alumni, the user can click on the directory/index tab. This will pull up a page that shows a list of users.</p>
            <img src="public/indexBoxed.jpg" alt="index tab boxed"></img>
            <p>To search for a specific user, the search bar at the top of the list can be used. Displayed users can be searched by name, achievemnts, and team by utilizing each respective search bar when the options button is clicked.</p>
            <img src="public/directorySearchBar.jpg" alt="directory with search bar boxed"></img>
            <img src="public/directorySearchBarOptions.jpg" alt="directory search bar with more search bars"></img>
